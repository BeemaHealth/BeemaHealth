...
| T7 | *(Optional)* **GA4 — generate_lead waitlist** | — | — | — | — | Covered by marketing `ad-conversions.ts`, not GTM | Do not duplicate in GTM unless waitlist Lead moves entirely into GTM. |
...
─────────────────                        ─────────────────────────
GTM-MHHJ44GF (gtm.js)                    GTM-MHHJ44GF (via Bask; gtm.js
Google Ads AW config (shell)               may load from analytics.bask.health)
