...
const FAQ_ITEMS: TreatmentFaqItem[] = [
  {
    q: "What is Beema Health's hair loss spray for women and how does it work?",
  ...
  },
  {
    ...
    a: `${simplePricingSentence("Beema Health's hair loss spray for women", HAIRLOSS_TOPICAL_WOMEN_PRICING)} Questions about your plan? ${patientQuestionsGuidance()}`,
  },
  {
  ...
  return (
    <MarketingLayout>
      ...
      <Section className="pt-0">
        <SectionHeading
          align="left"
          title="What is Beema Health's hair loss spray for women?"
        ...
        <div className="mt-6 max-w-2xl space-y-4 text-base leading-relaxed text-muted-foreground">
          ...
          <p>
            Beema Health's hair loss spray is a compounded formulation, for
            women only. {REQUIRED_COMPOUND_SENTENCE}
          </p>
          <p>
