  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        a: `No. Beema Health uses all-inclusive cash-pay pricing rather than a subscription or care-coordination membership model. If treatment is appropriate for you, your monthly cost is the listed plan rate — for example, compounded semaglutide is $${COMPOUNDED_SEMAGLUTIDE_PRICING.monthlyUsd}/month and compounded tirzepatide is normally $${COMPOUNDED_TIRZEPATIDE_PRICING.monthlyUsd}/month, each billed monthly with no long-term contract. Brand-new tirzepatide patients can start with a $${COMPOUNDED_TIRZEPATIDE_PRICING.starterPack!.totalUsd} starter pack ($${COMPOUNDED_TIRZEPATIDE_PRICING.starterPack!.monthlyEquivalentUsd}/month for ${COMPOUNDED_TIRZEPATIDE_PRICING.starterPack!.months} months). That rate already covers provider care, medication, supplies, and expedited shipping. We do not layer a separate platform fee, membership fee, or coordination fee on top. Because there's no membership locking you in, you can stop requesting refills at any time without needing to cancel a subscription — you only pay when medication is prescribed and you choose to fill it. A one-time promo code (${COMPOUNDED_SEMAGLUTIDE_PRICING.promoCode} for semaglutide, ${COMPOUNDED_TIRZEPATIDE_PRICING.promoCode} for tirzepatide) can also reduce your first month's cost when you purchase a three-month plan, though it never applies to a one-month purchase.`,
      },
      {
