...
metadata:
  origin: ECC
  installed-for: Beema Health (cherry-picked; not a full ECC install)
---
...
**Beema Health:** When this skill conflicts with `AGENTS.md`, `docs/HIPAA.md`, or `.cursor/rules/*`, those Beema docs win (PHI handling, validation layers, parameterized queries, no PHI in logs/storage).
